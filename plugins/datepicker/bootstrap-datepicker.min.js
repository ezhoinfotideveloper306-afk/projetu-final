...
! function(a) {
    ...
    var q = a.fn.datepicker.dates = {
            en: {
                days: ["Domingu", "Segunda", "Tersa", "Kuarta", "Konta", "Sesta", "Sabadu"],
                daysShort: ["Dom", "Seg", "Ter", "Kua", "Kin", "Ses", "Sab"],
                daysMin: ["Do", "Se", "Te", "Ku", "Ki", "Xe", "Sa"],
                months: ["Janeiru", "Fevereiru", "Marcu", "Abril", "Maiu", "Junnu", "Jullu", "Augustu", "Setembru", "Outubru", "Novembru", "Dezembru"],
